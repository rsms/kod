...
#
LIB=/usr/local/Cellar/source-highlight/3.1.4/lib/libsource-highlight.dylib
#
# -----------------------------------------------------------------------------
#
cd "$(dirname '$0')"
...
cp -vpr /usr/local/Cellar/source-highlight/3.1.4/include/srchilite include/srchilite
